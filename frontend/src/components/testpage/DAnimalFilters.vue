<template>
    <div class="filters">
        ...
        <div class="filter-category">
            <div @click="showFilters.hozName = !showFilters.hozName" class="ill-list-title">> Название хозяйства</div>
            <MultiselectHoz 
            @sendToMain="setIdHoz" 
        ...
        <div class="filter-category" v-if="!isBulls&&!isChild">
        ...
        <div class="filter-category" v-if="!isBulls">
