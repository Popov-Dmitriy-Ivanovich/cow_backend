...
type GaussianStatistics struct {
	...
	//MinCowIds pq.Int64Array `gorm:"type:integer[]"` // ID коров с минимальным значением индекса

	AvgIndex float64 // Значение среднего индекса
	AvgCount uint    // Количество коров с минимальным индексом
	//AvgCowIds pq.Int64Array `gorm:"type:integer[]"` // ID коров с средним значением индекса

	MaxIndex float64 // Значение максимального индекса
	MaxCount uint    // Количество коров с максимальным индексом
	//MaxCowIds pq.Int64Array `gorm:"type:integer[]"` // ID коров с максимальным значением индекса
}
